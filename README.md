...
|---|---|---|
| 🫀 [**heart-disease**](https://github.com/zmanangon09/heart-disease) | Sistema de predicción de enfermedades cardíacas: comparación XGBoost vs. MLP (metodología CRISP-DM, 918 registros, ROC-AUC > 0.90), con app web de diagnóstico | `Python` `XGBoost` `scikit-learn` `Flask` `React` |
...
![GitHub Streak Stats](https://streak-stats.demolab.com/?user=zmanangon09&theme=tokyonight&hide_border=true)

![Actividad de Zaith](https://github-readme-activity-graph.vercel.app/graph?username=zmanangon09&theme=tokyo-night&hide_border=true&area=true)
...
**¿Hablamos?** Escríbeme a [a.manangon09@gmail.com](mailto:a.manangon09@gmail.com)
